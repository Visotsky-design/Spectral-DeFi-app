...
extension View {
    ...
    func bodyMicroSem() -> some View {
        textStyle(font: .custom("SF Pro Text", size: 10),
                  weight: .semibold,
                  tracking: -0.4,
                  lineSpacing: 4)
    }
    func bodyXSmallMed() -> some View {
        textStyle(font: .custom("SF Pro Text", size: 12),
                  weight: .medium,
                  tracking: -0.3,
                  lineSpacing: 6)
    }
    ...
    func bodySmallMed() -> some View {
        textStyle(font: .custom("SF Pro Text", size: 14),
                  weight: .medium,
                  tracking: -0.5,
                  lineSpacing: 8)
    }
    ...
    func bodyMediumMed() -> some View {
        textStyle(font: .custom("SF Pro Text", size: 16),
                  weight: .medium,
                  tracking: -0.6,
                  lineSpacing: 8)
    }
    ...
    func bodyLargeMed() -> some View {
        textStyle(font: .custom("SF Pro Text", size: 18),
                  weight: .medium,
                  tracking: -0.8,
                  lineSpacing: 10)
    }
    ...
    func bodyXLargeMed() -> some View {
        textStyle(font: .custom("SF Pro Text", size: 20),
                  weight: .medium,
                  tracking: -0.9,
                  lineSpacing: 10)
    }
